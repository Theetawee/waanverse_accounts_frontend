            ...
            >
                ...
                <section className="h-screen flex flex-col justify-center items-center px-6">
                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        <button
                            type="button"
                            className="text-white bg-primary-700 hover:bg-primary-800  focus:ring-primary-300 font-medium rounded-lg text-lg px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                        >
                            Create account
                        </button>
                        <button
                            type="button"
                            className="py-2.5 ml-10 px-5 text-lg font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10  focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                        >
                            Login to account
                        </button>
                    </div>
