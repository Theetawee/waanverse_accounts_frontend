            ...
            <div>
                <div className="max-w-lg bg-white shadow mx-auto p-4 rounded">
                    {step === 1 && (
                        <form method="post" onSubmit={handleSubmit}>
                            <div className="mb-6">
                                ...
                                <p className="text-sm">
                                    Make sure you enter a verified correct email address associated with your account
                                </p>
                            </div>
                            <div className="mb-6">
                    ...
                    {step === 2 && (
                        <>
                            <div>
                                <p>We have sent an email to your email address. Please check your email and click on the link to reset your password.</p>
                        </div>
